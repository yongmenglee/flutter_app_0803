              ...
              child: Card(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 9),
                    Text(
                        " ${(_homePrice > 0 && _interest > 0.0) ? "\$${calculateMonthlyPayment(_homePrice, _interest, _lengthOfLoan)}" : ""}", style: TextStyle(fontSize: 20.0),),
                  ],
                ),
              ),
            ),
...
//                      color: Colors.blueGrey.shade100, //TODO: theme this!
                      color: primaryBrownLight.withOpacity(0.9), //TODO: theme this!
...
//                                  color: Colors.blueGrey.withOpacity(0.2),
                                  color: secondaryGreenLight.withOpacity(0.2),
                                ),
                                child: Center(
                                  child: Text("-"),
                                ), //TODO: Style Theme it!
