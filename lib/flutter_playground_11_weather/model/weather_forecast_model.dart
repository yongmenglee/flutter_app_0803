...
// [2] Rearrange JSON layout. https://codebeautify.org/jsonviewer
// [3] Convert JSON to Dart object. https://javiercbk.github.io/json_to_dart/
...
class WeatherForecastModel {
  ...
  WeatherForecastModel(
      {this.cod, this.message, this.cnt, this.listA, this.city});
  ...
  Map<String, dynamic> toJson() {
    ...
    data['cnt'] = this.cnt;
    if (this.listA != null) {
      data['list'] = this.listA.map((v) => v.toJson()).toList();
    }
    if (this.city != null) {
